...
class MangaParser:
    ...
    def _add_tags(self, result_data:dict[str, Any], soup:BeautifulSoup):
        ...
        try:
            ...
            for tag in tags:
                ...
                tag_data = {}
                tag_data['name'] = tag.text
                tag_data['href'] = tag.get('href', None)
                result_data.setdefault('tags', []).append(tag_data)
            return True
        except AssertionError:
            result_data.setdefault('tags', [])
            return False  

    def _add_description(self, result_data:dict[str, Any], soup:BeautifulSoup):
    ...
    def _add_info_list(self, result_data:dict[str, Any], soup:BeautifulSoup):
    ...
    def _add_href(self, result_data:dict[str, Any], soup:BeautifulSoup):
    ...
    def _get_manga_json(self, soup:BeautifulSoup):
    ...
    def _add_json_data(self, result_data:dict[str, Any], manga_json:dict[Any, Any]):
    ...
    def _add_teams(self, result_data:dict[str, Any], soup:BeautifulSoup, manga_json:dict[Any, Any]):
            ...
            for team in teams:
                ...
                if isinstance(div, Tag):
                    ...
                    if isinstance(style, str):
                        team_data['img'] = self._style_to_href(style)
    ...
    def _add_chapters(self, result_data:dict[str, Any], manga_json:dict[Any, Any]):
    ...
    def _add_in_lists(self, result_data:dict[str, Any], soup:BeautifulSoup):
    ...
    def _add_related(self, result_data:dict[str, Any], soup:BeautifulSoup):
        ...
        try:
            ...
            if isinstance(div, Tag):
                ...
                for div in divs:
                    ...
                    a_data.setdefault('img', self._style_to_href(str(a_div.get('style', ''))))
    ...
    def manga_html_parser(self, html_text:str):
        soup = BeautifulSoup(html_text, 'html.parser')
        result_data = {}

        assert self._add_img(result_data, soup)
        assert self._add_tags(result_data, soup)
        assert self._add_description(result_data, soup)
        assert self._add_info_list(result_data, soup)
        assert self._add_href(result_data, soup)
        manga_json = self._get_manga_json(soup)
        assert self._add_teams(result_data, soup, manga_json)
        assert self._add_json_data(result_data, manga_json)
        assert self._add_chapters(result_data, manga_json)
        assert self._add_in_lists(result_data, soup)
        assert self._add_related(result_data, soup)
...
if __name__ == '__main__':
    ...
    res = manga_parser.manga_html_parser(data)
