...
from .views import ListMangaPage, get_page, get_population_compressed, get_toxic_compressed, get_at_days, get_at_days_percent, get_24, get_comment_at
...
api = [
    ...
    path('manga_data/<slug:slug>/comment_at', get_comment_at, name='manga_data_comment_at'),
